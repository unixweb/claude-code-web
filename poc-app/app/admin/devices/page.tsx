                ...
                <div className="border-t border-gray-200 pt-4 space-y-2">
                  ...
                  {device.latestLocation.battery !== undefined && (
                    <div className="flex items-center justify-between text-sm">
                      <span className="text-gray-600 flex items-center gap-2">
                        <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 10h-2V7a1 1 0 00-1-1h-3V3a1 1 0 00-1-1H9a1 1 0 00-1 1v3H5a1 1 0 00-1 1v10a1 1 0 001 1h13a1 1 0 001-1v-3h2a1 1 0 001-1v-3a1 1 0 00-1-1z" />
                        </svg>
                        Battery:
                      </span>
